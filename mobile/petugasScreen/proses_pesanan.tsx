      ...
      >
        ...
        <View style={styles.orderSection}>
          ...
          <View style={styles.stockContainer}>
            <Image
              source={require('../assets/terkirim.png')}
              style={[styles.stockIcon, { tintColor: '#21C64B' }]}
              resizeMode="contain"
            />
            <View style={styles.stockTextContainer}>
              <Text style={styles.stockTitle}>Stock Tersedia!</Text>
              <Text style={styles.stockSubtitle}>Semua bahan tersedia, Pesanan siap di proses</Text>
            </View>
          </View>
          ...
          <View style={styles.buttonsContainer}>
            ...
            >
              <Image
                ...
                resizeMode="contain"
              />
              <Text style={styles.startButtonText}>Mulai masak sekarang</Text>
            </TouchableOpacity>

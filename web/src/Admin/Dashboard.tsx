        ...
        <div className="ml-55 flex-1 w-[calc(100vw-15rem)] px-8 py-10 bg-gray-100 overflow-y-auto md:px-12 lg:px-16">
            ...
            <div className="mt-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div className="relative bg-white p-5 rounded-xl shadow flex flex-col justify-center text-red-700 hover:bg-gradient-to-r hover:from-red-900 hover:to-white-900 hover:text-white transition duration-300 cursor-pointer group">
                    <img src="/image/Tp1.png" alt="icon" className="absolute top-3 right-3 w-6 h-6 transition duration-300 " />
                    <p className="text-gray-700 text-sm group-hover:text-white">Total Penjualan</p>
                    <h4 className="font-bold text-xl">2500</h4>
                    <small className="text-gray-700 group-hover:text-white">Bulan Lalu :</small>
                </div>

                {/* Card 2 */}
                <div className="relative bg-white p-5 rounded-xl shadow flex flex-col justify-center text-red-700 hover:bg-gradient-to-r hover:from-red-900 hover:to-white-900 hover:text-white transition duration-300 cursor-pointer group">
                    <img src="/image/Tp2.png" alt="icon" className="absolute top-3 right-3 w-6 h-6 transition duration-300 " />
                ...
                {/* Card 3 */}
                <div className="relative bg-white p-5 rounded-xl shadow flex flex-col justify-center text-red-700 hover:bg-gradient-to-r hover:from-red-900 hover:to-white-900 hover:text-white transition duration-300 cursor-pointer group">
                    <img src="/image/Tp3.png" alt="icon" className="absolute top-3 right-3 w-6 h-6 transition duration-300 " />
                    <p className="text-gray-700 text-sm group-hover:text-white">Total Pelanggan</p>
                ...
                {/* Card 4 */}
                <div className="relative bg-white p-5 rounded-xl shadow flex flex-col justify-center text-red-700 hover:bg-gradient-to-r hover:from-red-900 hover:to-white-900 hover:text-white transition duration-300 cursor-pointer group">
                    <img src="/image/Tm.png" alt="icon" className="absolute top-3 right-3 w-6 h-6 transition duration-300 " />
                    <p className="text-gray-700 text-sm group-hover:text-white">Total Menu</p>
            ...
            <div className="mt-10 bg-white p-6 rounded-xl shadow w-full">
                <div className="flex justify-between items-center mb-3">
                    <div className="mb-4">
                        <h2 className="text-[#a62418] font-bold text-lg mb-1">Grafik Pendapatan Harian</h2>
                ...
                <div className="w-full h-56">
                    <ResponsiveContainer width="100%" height="100%">
                        <LineChart data={dataPendapatan} margin={{ top: 10, right: 30, left: 0, bottom: 10 }}>
                            <defs>
                            ...
                            <YAxis tickFormatter={(value) => `Rp ${value / 1000}K`} tick={{ fontSize: 12, fill: "#a62418" }} />
            ...
            <div className="mt-10 bg-white p-6 rounded-xl shadow w-full">
                ...
                <div className="flex gap-6 overflow-x-auto pb-4 scrollbar-thin scrollbar-thumb-red-800 scrollbar-track-gray-200">
                    {menuItems.map((menu) => (
                        ...
                        >
                            <img src={menu.image} alt={menu.name} className="w-full h-36 object-cover rounded-lg mb-2" />
                            ...
                            <button className="flex items-center gap-1 bg-[#ffe0e0] text-[#b91c1c] text-[13px] font-medium px-3 py-[4px] rounded-full mt-3 transition-all duration-300 group-hover:bg-gradient-to-r group-hover:from-white group-hover:to-red-900 group-hover:text-white">
                                <span>❤️</span>
            ...
            {/* ====================== STATUS TRUCK ====================== */}
            <div className="mt-10 bg-white p-6 rounded-xl shadow w-full mb-8">
                <div className="mb-4">
                        ...
                        >
                            <div className="flex items-center gap-3">
                                ...
                                <div className="flex flex-col">
                                    ...
                                    <span className="text-gray-700 text-sm">{truck.orders} Orders</span>
                                </div>
                            </div>
                            <span className="text-green-600 font-semibold">Rp {truck.revenue.toLocaleString("id-ID")}</span>
                        </div>
                    ))}
                </div>
            </div>
